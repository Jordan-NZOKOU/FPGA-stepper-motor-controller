...
set_property PACKAGE_PIN J19 [get_ports Empty]
set_property PACKAGE_PIN K2 [get_ports Full]
set_property PACKAGE_PIN L1 [get_ports rotary_A]
set_property PACKAGE_PIN J1 [get_ports rotary_B]
...
set_property PACKAGE_PIN B17 [get_ports {RGB[0]}]
set_property PACKAGE_PIN B16 [get_ports {RGB[1]}]
set_property PACKAGE_PIN C17 [get_ports {RGB[2]}]
