...
entity encodeur_numerique is
	 ...
	 Port ( CLK : in  STD_LOGIC; --255Hz
            ...
            start_moteur_up : out STD_LOGIC;
            start_moteur_down : out STD_LOGIC;
			compte_out_codeur : out STD_LOGIC_VECTOR(7 downto 0));
			  
end encodeur_numerique;

architecture Behavioral of encodeur_numerique is
...
start_moteur_up <='1' when BTN0 ='1' else '0';
start_moteur_down <='1' when BTN1 ='1' else '0';
